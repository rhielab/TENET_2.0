...
top=list(gene=as.character(genelist$V1), links=as.character(links), prefix=as.character(prefix))
...
mcmapply(makeScatterG, top$gene, top$links, top$prefix, mc.cores=cores)
