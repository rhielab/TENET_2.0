...
do
	...
	mv $thefile.probelist.txt ../../scripts/step1/hm450overlap/enhancer/
	rm *txt
done
cat ../../scripts/step1/hm450overlap/enhancer/*txt | sort | uniq > ../../scripts/step1/hm450overlap/enhancer/external.data.enhancer.hm450.probelist.txt
