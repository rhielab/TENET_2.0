...
![Example histogram output](https://github.com/suhnrhie/TENET_2.0/blob/master/example_images/histogram_example.png?raw=true)
...
![Example scatterplot output](https://github.com/suhnrhie/TENET_2.0/blob/master/example_images/scatterplot_example.png?raw=true)
...
![Example gene expression survival plot output](https://github.com/suhnrhie/TENET_2.0/blob/master/example_images/gene_expression_survival_example.png?raw=true)

![Example DNA methylation survival plot output](https://github.com/suhnrhie/TENET_2.0/blob/master/example_images/DNA_methylation_probe_survival_example.png?raw=true)
...
![Example circos plot output](https://github.com/suhnrhie/TENET_2.0/blob/master/example_images/circos_example.png?raw=true)
...
![Example heatmap output](https://github.com/suhnrhie/TENET_2.0/blob/master/example_images/heatmap_example.png?raw=true)
