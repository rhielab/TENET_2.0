...
##### States output:
States functions output files that list the activation status of each enhancer probe-transcriptional regulator link. For example, below file generated in Lung adenocarcinoma data indicates that tumor sample TCGA-05-4415-01A-22 has activated enhancer probe cg00019511 linked to FOXM1, CENPA, and TCF24 while other samples don't harbor. Users can search the activities of top n transcriptional regulators and their linked enhancers by using states_n_  enhancer activity and transcriptional regulator activity states of samples using this function.
